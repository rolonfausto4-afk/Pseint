...
Funcion total_productos= totalproductosfuncion(precio_productos,cantidad,tl_pt)
	Definir total_productos Como Real;
	total_productos= tl_pt + (precio_productos*cantidad);
FinFuncion

Funcion acumulador_txt = acumuladortxt(productos,precio_productos,i,cantidad,am_txt)
	Definir acumulador_txt como cadena;
	acumulador_txt= am_txt + ConvertirATexto(i) + ". " + productos + " con precio: " +ConvertirATexto(precio_productos)+ " Cantidad del producto: " + ConvertirATexto(cantidad) + ". ";
FinFuncion

Funcion para_funcion(cantidad_productos,productos,precio_productos,total_productos,acumulador_txt,cantidad)
	...
	para i=1 Hasta cantidad_productos Hacer
		...
		total_productos= totalproductosfuncion(precio_productos,cantidad,total_productos);
		acumulador_txt = acumuladortxt(productos,precio_productos,i,cantidad,acumulador_txt);
	FinPara
...
Algoritmo sin_titulo
	...
	para_funcion(cantidad_productos,productos,precio_productos,total_productos,acumulador_txt,cantidad);
FinAlgoritmo
